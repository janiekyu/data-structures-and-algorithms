...
const countNumberOfElements = (arr) => {
  let counter = arr.reduce((previousValue, currentValue, currentIndex, array)=>{
...
const returnNames = (arr) => {
  let newArr = arr.reduce((previousValue, currentValue, currentIndex, array )=> {
...
const reversedString = (str) => {
  ...
  let reverseArr = newArr.reduce ((previousValue, currentValue, currentIndex, array)=>{
...
const countNumberOfChildren = (arr) => {
  let totalKids = 0
  let reduceResults = arr.reduce((previousValue, currentValue, currentIndex, array) => {
    if (currentValue.children) {
      totalKids += currentValue.children.length;
    }
    return totalKids;
  },0)
...
const calculateAverage = (arr) => {
  let newArr = arr.reduce((previousValue, currentValue, currentIndex, arrray)=> {
...
const countPrimeNumbers = (arr) => {
  ...
  let reduceResult = arr.reduce((previousValue, currentValue, currentIndex, array) => {
    if (isPrime(currentValue)) {
      return numberOfPrimes +=1;
    }

...
public class RepeatedWordsTest {
    ...
    public void testBookSplit1(){
        ...
        assertEquals("it", RepeatedWords.splitBook(book));
    }

    @Test
    public void testBookSplit2(){
        String book = "Once upon a time, there was a brave princess who...";
        assertEquals("a", RepeatedWords.splitBook(book));
    }

    @Test
    public void testBookSplit3(){
        ...
        assertEquals("summer", RepeatedWords.splitBook(book));
    }
